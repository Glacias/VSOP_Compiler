...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','example.py',60),
  ('statement -> expression','statement',1,'p_statement_expr','example.py',64),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','example.py',68),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','example.py',69),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','example.py',70),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','example.py',71),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','example.py',78),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','example.py',82),
  ('expression -> NUMBER','expression',1,'p_expression_number','example.py',86),
  ('expression -> NAME','expression',1,'p_expression_name','example.py',90),
]
